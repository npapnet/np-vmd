...
# TODO move this to examples and better yet to documentation
...
def Free_Generic(t, zeta=1, wn=1, x0 =1, xdot0=0):
    """
    Simulates the free response of a damped harmonic oscillator under free vibration.

    Parameters
    ----------
    t : float
        Time at which to compute the displacement.
    zeta : float, optional
        Damping ratio of the system (default is 1).
    wn : float, optional
        Natural frequency of the system (default is 1).
    x0 : float, optional
        Initial displacement of the system (default is 1).
    xdot0 : float, optional
        Initial velocity of the system (default is 0).
